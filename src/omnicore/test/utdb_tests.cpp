...
BOOST_AUTO_TEST_SUITE(omnicore_utdb_tests)

BOOST_AUTO_TEST_CASE(utdb_test_sequence)
{
    LOCK(cs_tally);
    p_utdb->Clear();
    ...
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 1));
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 1000));
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 454));
    ...
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 1001));
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 2000));
    BOOST_CHECK(p_utdb->IsRangeContiguous(50, 1, 2000));
    ...
    BOOST_CHECK_EQUAL("Bob", p_utdb->GetUniqueTokenOwner(50, 2001));
    BOOST_CHECK_EQUAL("Bob", p_utdb->GetUniqueTokenOwner(50, 3000));
    BOOST_CHECK(!p_utdb->IsRangeContiguous(50, 2000, 2001));
     ...
     */
    BOOST_CHECK(p_utdb->MoveUniqueTokens(50, 2001, 3000, "Bob", "Charles"));
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 2001));
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 3000));
    ...
    BOOST_CHECK_EQUAL("David", p_utdb->GetUniqueTokenOwner(50, 3001));
    BOOST_CHECK_EQUAL("David", p_utdb->GetUniqueTokenOwner(50, 4000));
    BOOST_CHECK(!p_utdb->IsRangeContiguous(50, 3000, 3001));
    BOOST_CHECK(p_utdb->MoveUniqueTokens(50, 3001, 4000, "David", "Charles"));
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 3001));
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 4000));
    BOOST_CHECK(p_utdb->IsRangeContiguous(50, 3000, 3001));
     ...
     */
    BOOST_CHECK_EQUAL("Alice", p_utdb->GetUniqueTokenOwner(50, 500));
    BOOST_CHECK(p_utdb->MoveUniqueTokens(50, 500, 500, "Alice", "Bob"));
    BOOST_CHECK_EQUAL("Bob", p_utdb->GetUniqueTokenOwner(50, 500));
     ...
     * - Check that the range 2300-2400 is contiguous
     */
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 2300));
    BOOST_CHECK_EQUAL("Charles", p_utdb->GetUniqueTokenOwner(50, 2400));
    BOOST_CHECK(p_utdb->IsRangeContiguous(50, 2300, 2400));
    BOOST_CHECK(p_utdb->MoveUniqueTokens(50, 2300, 2400, "Charles", "Bob"));
    BOOST_CHECK_EQUAL("Bob", p_utdb->GetUniqueTokenOwner(50, 2300));
    BOOST_CHECK_EQUAL("Bob", p_utdb->GetUniqueTokenOwner(50, 2400));
    BOOST_CHECK(p_utdb->IsRangeContiguous(50, 2300, 2400));
}
